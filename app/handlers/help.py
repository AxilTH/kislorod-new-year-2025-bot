...
async def handler_help(message: Message):
   ...
   text = textwrap.dedent(
   '''
      🎄 Волшебная книга таинственных новогодних заклинаний бота <b>"Новогодняя игра от СПО «Кислород»"</b>:

      /start — Начать новогоднее путешествие 🎇
      /message — Прочесть ежедневное зимнее послание ✨
      /task — Получить задание от Снеговика-помощника ⛄️
      /events — Заглянуть в расписание зимних встреч 🗓️
